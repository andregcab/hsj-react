    ...
    <div>
      ...
      <div className="description">
        ...
        <p>
          ...
          part into a unique representation of Hops Skips and Jumps. Plan a trip
          and share your ideas with the world. Havent made an account yet? No
          problem, you can still check out other user's{" "}
